...
![Figure 1: Correlation plot of factor variables in the Heart Failure dataset.](images/correlation.png)

![Figure 2: Correlation plot of continuous variables in the Heart Failure dataset.](images/correlation2.png)
...
![Figure 3: Number of Patient deaths by Gender.](images/gender.png)
...
![Figure 4: Distribution of deaths by Age.](images/age.png)

There doesn't seem to be much of a difference of creatinine phosphokinase levels between alive/dead patients:

![Figure 5: Distribution of patient deaths by creatinine phosphokinase.](images/cp.png)


Those who die have a lower ejection fraction on average than those who have survived:

![Figure 6: Distribution of patient deaths by ejection fraction.](images/ef.png)


The platelet count does not appear to be a significant factor in survival:

![Figure 7: Distribution of patient deaths by platelet count.](images/platelets.png)

The levels of creatinine are higher in those who die:

![Figure 8: Distribution of patient deaths by creatinine.](images/sc.png)

The level of sodium is lower on average in those who die:

![Figure 9: Distribution of patient deaths by sodium.](images/ss.png)
...
![Figure 10: Gender-Diabetes relationship.](images/genderdiabetes.png)

Women who smoke more likely to die than men who smoke (very small sample size, however):

![Figure 11: Gender-smoking relationship.](images/gendersmoking.png)


Those with diabetes who also smoke are at most risk:

![Figure 12: Smoking-Diabetes relationship.](images/smokingdiabetes.png)


Not a strong relationship between sodium levels and age - correlation likely due to outliers:

![Figure 13: Creatinine-Age relationship.](images/sc_age.png)


Also a weak correlation between levels of sodium and creatinine:

![Figure 14: Sodium-Creatinine relationship](images/ss_sc.png)
...
![Figure 15: Sodium-Ejection fraction relationship.](images/ss_ef.png)
...
We assume a linear relationship between the explanatory variables and the log-odds (also called logit) of the event that $Y = 1$. This linear relationship can be written in the following mathematical form (where ℓ is the log-odds, $b$ is the base of the logarithm, and $\beta _{i}$ are parameters of the model):

\begin{equation}
ℓ = \log_{b}{\frac {p}{1-p}}= \beta_{0} + \beta_{1}x_{1} + \beta_{2}x_{2}
\end{equation}
...
![Figure 16: Cross validation results for logistic regression model. Optimal p is `r opt_p`.](images/cv_p.png)
...
![Figure 17: Second cross validation results for logistic regression model. Optimal p is `r opt_p_two`.](images/cv_p_2.png)
...
![Figure 18: Cross validation results for Naive Bayes model. Optimal model is the Nonparametric model.](images/cv_nb.png)
...
![Figure 19: Bootstrap (25 samples of 25% of the data) results from decision tree. Optimal cp is `r opt_cp`.](images/cv_dt.png)
...
![Figure 20: Decision tree.](images/tree_plot.png)
...
![Figure 21: Bootstrap results for various values of mtry. The optimal mtry is `r opt_mtry`](images/cv_rf.png)
...
![Figure 22: CV results for various cost values. The optimal cost is `r opt_cost`](images/cv_svm.png)
...
results %>%
  slice(1:5) %>%
  kable(caption = "Table 5: results after construction of the fifth model")
```
...
results %>%
  slice(1:6) %>%
  kable(caption = "Table 6: results after construction of all the models")
```
